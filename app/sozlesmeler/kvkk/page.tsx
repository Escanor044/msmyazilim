...
export default function KVKK() {
    ...
    const fetchPage = async () => {
        try {
            ...
            console.error('Error fetching KVKK page:', error)
        } finally {
            setLoading(false)
        }
    }
    ...
    return (
        <LegalLayout
            ...
            description={page?.description || "Kişisel Verilerin Korunması Kanunu kapsamında haklarınız ve verilerinizin işlenmesi hakkında bilgilendirme."}
