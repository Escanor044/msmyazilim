...
export default function HardEmekPage() {
    return (
        <main className="min-h-screen bg-background pt-32 pb-16">
            <div className="container-width max-w-7xl mx-auto">
                ...
                <Card className="glass-card p-8 md:p-12 rounded-3xl mb-8 border-blue-500/60">
                    <div className="mb-8">
                        <div className="inline-block bg-gradient-to-r from-blue-600 via-blue-500 to-blue-600 text-white text-xs font-black px-6 py-2 rounded-full shadow-lg border border-blue-400/30 mb-4 uppercase tracking-widest">
                            POPÜLER
                        </div>
                        <span className="text-xs font-black tracking-[0.2em] text-blue-400 uppercase block">
                            1-99 HARD EMEK
                        </span>
                        ...
                        <p className="text-lg text-muted-foreground mt-4">
                            Yüksek zorluk seviyesi sunan, zorlu ve meydan okuyucu bir deneyim için tasarlanmış server files paketi.
                        </p>
                    </div>
                    ...
                    <div className="space-y-4 mb-8">
                        <div className="flex items-center gap-4 text-white/90">
                            ...
                            <span className="text-base font-medium">Yüksek zorluk seviyesi</span>
                        </div>
                        <div className="flex items-center gap-4 text-white/90">
                            <div className="flex-shrink-0 w-6 h-6 rounded-full flex items-center justify-center border border-blue-500/50 bg-blue-500/10">
                                <Check className="w-3 h-3 text-blue-400" strokeWidth={3} />
                        ...
                        <div className="flex items-center gap-4 text-white/90">
                            ...
                            <span className="text-base font-medium">Zorlu ve meydan okuyucu</span>
                        </div>
                    </div>
